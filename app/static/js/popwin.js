...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTitle" style=" width:491px; height: 35px; line-height: 35px; font-family: Microsoft Yahei; font-weight:bold; font-size: 15px; color: #333333; padding-left: 20px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        inntHtml += '' + title + ''
